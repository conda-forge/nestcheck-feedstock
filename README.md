...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/nestcheck-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11053&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/nestcheck-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `nestcheck` can be installed with:

```
conda install nestcheck
```

It is possible to list all of the versions of `nestcheck` available on your platform with:
